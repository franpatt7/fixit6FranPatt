...
if (userStateCapital == "NE" && userTemp < 32)
    NSB.MsgBox(`${userNameCapital}, ${message[0]}`);
    
else if (userStateCapital == "NE" && userTemp >= 32 && userTemp <= 50)
    NSB.MsgBox(`${userNameCapital}, ${message[1]}`);
    
else if (userStateCapital == "FL" && userTemp >= 32 && userTemp <= 50)
    NSB.MsgBox(`${userNameCapital}, ${message[2]}`);
    
else if (userStateCapital == "FL" && userTemp > 50 && userTemp <= 70)
